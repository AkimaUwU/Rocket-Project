...
public sealed record TimeZoneDbApiKeySetupController
{
    ...
    public TimeZoneDbApiKeySetupController(
    ...
    public async Task OnStart(ITelegramBotClient client, Update update)
    {
        ...
        {
            Result<TimeZoneDbOptions> timeZoneOptions = _repository.Get(
        ...
        _logger.Information(
            "{Context}. Time Zone Db Api Token Configuration started.",
            nameof(TimeZoneDbApiKeySetupController)
        );
    }
    ...
    public async Task OnClientTokenReply(ITelegramBotClient client, Update update)
    {
        ...
        _logger.Information(
            "{Context}. Time Zone Db Api Token Configuration saved.",
            nameof(TimeZoneDbApiKeySetupController)
        );
        await client.RegisterCommandIfNotExists(
            "/update_time_api_key",
    ...
    public async Task OnCancel(ITelegramBotClient client, Update update)
    {
        ...
        _logger.Information(
            "{Context}. Time Zone Db Api Token Configuration canceled.",
            nameof(TimeZoneDbApiKeySetupController)
        );
    }
    ...
    public async Task HasApiToken(ITelegramBotClient client, Update update)
    {
        ...
        Result<TimeZoneDbOptions> timeOptionsResult = _repository.Get(
            ConfigurationVariables.TimeZoneDbTokenConfigPath
        );
        var message = timeOptionsResult.IsSuccess switch
        {
            true => await Message.Send(
                client,
                update,
                "В боте существуте конфигурация Time Zone Db."
            ),
