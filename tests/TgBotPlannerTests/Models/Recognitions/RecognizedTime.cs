    ...
    : PeriodicRecognition
{
    public override ApplicationTime Calculate(ApplicationTime calculation)
    {
        ApplicationTime calculated = DayOfWeek.Calculate(calculation);
        return new ApplicationTime(calculated, true);
    }
...
public sealed record PeriodicEveryDayRecognition(RelativeRecognition Relative) : PeriodicRecognition
{
    public override ApplicationTime Calculate(ApplicationTime calculation)
    {
        ApplicationTime calculated = Relative.Calculate(calculation);
        return new ApplicationTime(calculated, true);
    }
    ...
    : PeriodicRecognition
{
    public override ApplicationTime Calculate(ApplicationTime calculation)
    {
        ApplicationTime calculated = Specific.Calculate(calculation);
        return new ApplicationTime(calculated, true);
    }
